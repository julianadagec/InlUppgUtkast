...
// - räknar totalt antal raderna exklusive ordet stop
...
public class ControlText {
    ...
    // Nedan metod bearbetar den text användaren matar in till att den skriver 'stop'
    ...
    public void processInput (String input) {
        ...
        // förs försökte jag splitta orden med bara "" och det funkade i programmet tills att
        // jag försökte kontrollera det med ett test och fick fel i testet, efter research hittade jag
        ...
        // Alla ord i arrayen words kontrollas för att hitta första längsta ordet
        // (side note: försökt koda så att den skriver ut alla lika långa ord men det
        // blev alldeles för komplext så har valt att köra koden som väljer ut
        // det första långa ordet om fler ord av samma längds skulle förekomma)
